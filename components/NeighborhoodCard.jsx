...
const NeighborhoodCard = ({ title, image, effect }) => {
  return (
    <div data-aos={effect} className={`relative ${image} bg-cover bg-no-repeat bg-center w-full lg:w-1/2 min-h-[30rem] lg:min-h-[38.8rem]`}
    >
