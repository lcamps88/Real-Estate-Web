  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        neighborhoods3: "url('/images/jupiter.webp')",
        neighborhoods4: "url('/images/lakeWorth.webp')",
        neighborhoods5: "url('/images/palmSpring.webp')",
        neighborhoods6: "url('/images/royalPalm.webp')",
        neighborhoods7: "url('/images/wellington.webp')",
        neighborhoods8: "url('/images/neighborhoods8.webp')",
        neighborhoods9: "url('/images/neighborhoods9.webp')",
        neighborhoods10: "url('/images/neighborhoods10.webp')",
      },
      backgroundVideo: {
